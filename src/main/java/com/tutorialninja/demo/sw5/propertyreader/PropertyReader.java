package com.tutorialninja.demo.sw5.propertyreader;
...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName) {
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/com/tutorialninja/demo/sw5/resources/propertiesfile/config.properties");
